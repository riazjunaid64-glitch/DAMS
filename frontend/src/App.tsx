  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      >
        ...
        {/* Mobile Menu */}
        {mobileOpen && (
          <div className="animate-fade-in border-t border-[var(--border)] bg-[var(--nav-bg)] backdrop-blur-xl sm:hidden">
            <Container className="py-5">
              <div className="flex flex-col gap-1">
                ...
                <div className="mt-4 flex items-center justify-between border-t border-[var(--border)] pt-4 px-1">
                  <span className="text-sm font-medium text-[var(--text-secondary)]">Theme</span>
                  <button
                    onClick={toggleTheme}
                    className="flex h-10 w-10 items-center justify-center rounded-xl border border-[var(--border)] bg-[var(--surface-glass)] text-[var(--text-primary)] transition hover:bg-[var(--surface-glass-hover)]"
                    aria-label="Toggle theme"
                  >
                    {theme === "dark" ? (
