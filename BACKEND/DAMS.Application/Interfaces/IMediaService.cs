...
namespace DAMS.Application.Interfaces
{
    public interface IMediaService
    {
        ...
        Task<ProjectMediaResponseDto?> UpdateProjectMediaAsync(int mediaId, UpdateMediaDto updateDto);
        ...
        Task<UnitMediaResponseDto?> UpdateUnitMediaAsync(int mediaId, UpdateMediaDto updateDto);
