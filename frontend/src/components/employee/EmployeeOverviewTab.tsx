...
export default function EmployeeOverviewTab({ employee, onEmployeeUpdate }: Props) {
  ...
  const infoItems = [
    ...
    { icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><path d="M16 8h-6a2 2 0 100 4h4a2 2 0 110 4H8"/><path d="M12 18V6"/></svg>, label: "Salary",      value: `$${employee.salary.toLocaleString()}` },
